      ...
      <div className="max-w-7xl mx-auto px-6 py-20 space-y-32 pt-24">
        ...
        >
          ...
          <motion.p
            ...
            variants={itemVariants}
          >
            Frontend Developer with expertise in React, Tailwind CSS,
            TypeScript, and modern web technologies. Dedicated to crafting
            high-performance, scalable applications with a focus on user
        ...
        >
          <motion.div className="space-y-8" variants={itemVariants}>
            ...
            >
              ...
              dynamic and responsive web applications. With a strong background
              in computer science, I excel in translating complex requirements
              into intuitive user interfaces. My approach emphasizes performance
              optimization, accessibility, and cross-browser compatibility.
            </motion.p>
            <motion.div
            ...
            >
              ...
              <ul className="list-none space-y-3 text-gray-400">
                <li className="flex items-start gap-2">
                  <span className="text-blue-400">•</span> Bachelor's Degree in
                  Computer Science from I-fatoss University, graduated with
                  honors.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400">•</span> 2+ years of
                  professional experience in frontend development, including
                  freelance projects.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400">•</span> Contributed to
                  open-source repositories on GitHub.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400">•</span> Experience in agile
                  environments, collaborating with cross-functional teams.
                </li>
              </ul>
            </motion.div>
            <motion.div
            ...
            >
              ...
              <ul className="list-none space-y-3 text-gray-400">
                <li className="flex items-start gap-2">
                  <span className="text-blue-400">•</span> Deep knowledge of
                  React ecosystem: Hooks, Context API, and also state
                  management.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400">•</span> Proficient in
                  performance profiling using Chrome DevTools .
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400">•</span> Understanding of web
                  accessibility and SEO best practices.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400">•</span> Skilled in
                  unit/integration testing with, React Testing Library.
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400">•</span> Familiar with CI/CD
                  pipelines using GitHub Actions and deployment on
                  Vercel/Netlify.
                </li>
              </ul>
            </motion.div>
          ...
          >
            <AnimatePresence>
              <motion.div variants={iconVariants} whileHover="hover">
                <SiReact size={56} className="text-blue-500" title="React" />
              </motion.div>
              <motion.div variants={iconVariants} whileHover="hover">
                <SiTailwindcss
                  size={56}
              ...
              <motion.div variants={iconVariants} whileHover="hover">
                <SiHtml5 size={56} className="text-orange-600" title="HTML5" />
              </motion.div>
              <motion.div variants={iconVariants} whileHover="hover">
                <SiCss3 size={56} className="text-blue-600" title="CSS3" />
              </motion.div>
              <motion.div variants={iconVariants} whileHover="hover">
                <SiGit size={56} className="text-orange-600" title="Git" />
              </motion.div>
            </AnimatePresence>
          </motion.div>
          <motion.div
        ...
        >
          ...
          >
            ...
            just to connect. I’m always open to discussing new ideas and
            opportunities.
          </motion.p>
          <motion.div
